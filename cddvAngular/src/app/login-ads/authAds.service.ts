...
export class AuthAdsService {

  private loginAdsApi : string = "http://localhost:3000/api/loginAds"
   ...
   */
  public loginAds(cpf:String, senha:String) : Observable<Agente>{
    console.log('cpf',cpf)
    console.log('senha',senha)
    return this.http.post<Agente>(this.loginAdsApi, {cpf, senha} , httpOption)
                    .pipe(
                            catchError(
                                        this.errorHandler
                                      )
